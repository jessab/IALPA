...
cell(Row1,Col1,num(Num))\cell(Row2,Col2,pos(Pos))<=>
	square_number(Row1,Col1,Square),square_number(Row2,Col2,Square),
	select(Num,Pos,NewPos)|cell(Row2,Col2,pos(NewPos)).
